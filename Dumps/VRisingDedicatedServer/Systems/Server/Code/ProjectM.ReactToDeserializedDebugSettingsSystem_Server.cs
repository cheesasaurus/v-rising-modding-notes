...
public class ReactToDeserializedDebugSettingsSystem_Server : SystemBase
{
    EntityQuery __query_524302137_0;
    
    public void Example_InitEntityQueries(EntityManager entityManager)
    {
        __query_524302137_0 = entityManager.CreateEntityQuery(new EntityQueryDesc()
        {
