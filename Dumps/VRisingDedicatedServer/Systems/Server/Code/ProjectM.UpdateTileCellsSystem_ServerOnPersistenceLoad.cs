...
public class UpdateTileCellsSystem_ServerOnPersistenceLoad : ProjectM.UpdateTileCellsSystem
{
    EntityQuery _Query;
    EntityQuery __query_402779667_0;
    EntityQuery __query_402779667_1;
    ...
    public void Example_InitEntityQueries(EntityManager entityManager)
    {
        ...
        __query_402779667_0 = entityManager.CreateEntityQuery(new EntityQueryDesc()
        {
            All = new ComponentType[] {
        ...
        __query_402779667_1 = entityManager.CreateEntityQuery(new EntityQueryDesc()
        {
            All = new ComponentType[] {
