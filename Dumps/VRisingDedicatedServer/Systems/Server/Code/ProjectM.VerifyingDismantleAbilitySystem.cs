...
public class VerifyingDismantleAbilitySystem : SystemBase
{
    ...
    EntityQuery __query_1312974575_0;
    EntityQuery __query_1312974575_1;
    ...
    public void Example_InitEntityQueries(EntityManager entityManager)
    {
        ...
        __query_1312974575_0 = entityManager.CreateEntityQuery(new EntityQueryDesc()
        {
            All = new ComponentType[] {
        ...
        __query_1312974575_1 = entityManager.CreateEntityQuery(new EntityQueryDesc()
        {
            All = new ComponentType[] {
